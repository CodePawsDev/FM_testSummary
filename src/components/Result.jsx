const Result = () => {
    ...
    return (
        <div className={`h-[400px] md:w-1/2 md:h-full rounded-b-3xl md:rounded-3xl flex flex-col justify-center items-center ${bgGradient}`}>
          <h2 className="font-bold text-gray-300 text-2xl">Your Result</h2>
          <div className={`w-[150px] h-[150px] rounded-full flex flex-col justify-center items-center my-8 ${circleGradient}`}>
          ...
          <p className="text-gray-200 w-3/6 md:w-4/6 text-center">You scored higher than 65% of the people who have taken these tests.</p>
        </div>
    )
}
